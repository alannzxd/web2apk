# Web2APK Pro Bot Gen 2 - VPS Edition
...
```bash
# Download script
wget https://raw.githubusercontent.com/alannzxd/web2apk/main/scripts/setup-vps.sh
...
```bash
git clone https://github.com/alannzxd/web2apk.git
cd web2apk
npm install
cp .env.example .env
...
**alannxd** - [@alannxd](https://t.me/alannxd)
